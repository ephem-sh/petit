...
function writeErrorFiles(appRoot: string, error: string): void {
	...
	writeFileSync(
		...
		`// Auto-generated by petit — config error\nexport const config = { title: "petit", defaultScheme: "system", schemeSwitcher: true, theme: "default", themeOverrides: {}, logo: null, logoDark: null, maxWidth: "md", sidebarPosition: "left", toc: true, repository: null, branch: "main", siteUrl: null, favicon: null, shiki: { light: "github-light", dark: "github-dark" } } as { title: string; defaultScheme: "dark" | "light" | "system"; schemeSwitcher: boolean; theme: string; themeOverrides: Record<string, unknown>; logo: string | null; logoDark: string | null; maxWidth: "sm" | "md" | "lg" | "xl"; sidebarPosition: "left" | "right" | "center"; toc: boolean; repository: string | null; branch: string; siteUrl: string | null; favicon: string | null; shiki: { light: string; dark: string } }\n`,
		"utf-8",
	)
	writeFileSync(
